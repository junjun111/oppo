$(function() {
				...
				$('.next').click(function() {
					...
					$('.img').stop().animate({ left: -i * 1263 }, 1000);
				...
				$('.prev').click(function() {
					...
					if(i == -1) {
						i = $('.img li').length - 2;
						$('.img').css({ left: -($('.img li').length - 1) * 1263 });
					}
					$('.img').stop().animate({ left: -i * 1263 }, 1000);
					$('.num li').eq(i).addClass('active').siblings().removeClass('active');
				})
...
//				})
				...
				$(".prev").mouseover(function(){
					$(this).css({"color":"rgba(255,255,254,0.6)"});
				});
				$('.num li').mouseover(function() {
					var _index = $(this).index();
					$('.img').stop().animate({ left: -_index * 1263 }, 800);
				...
				timer = setInterval(function() {
					...
					$('.img').stop().animate({ left: -i * 1263 }, 800);
